...
-- Duplicate Check 
with duplicates as -- -- Use a CTE with ROW_NUMBER() to identify logical duplicate records.
(select 
	JourneyID,
	CustomerID,
	ProductID,
...
-- Check for inconsistent letter casing using a case-sensitive collation.
